"use client"
import OrbitingCircles from "@/components/LayoutEN/magicui/orbiting-circles"
import { motion } from "framer-motion"
import { Button } from "@nextui-org/button"
import TypeIt from "typeit-react"
import Link from "next/link"
import ScrollAnimation from "@/components/LayoutEN/Transitions/PageTransition"
                    ...
                    <h2 className="mb-3">
                      <TypeIt
                        ...
                        getBeforeInit={(instance) => {
                          instance
                            .type("System & Cloud Infrastructure")
                            .pause(750)
                            .delete(29)
                            .pause(500)
                  ...
                  <div className="mx-auto max-w-2xl">
                    <div className="relative mx-auto w-full rounded-full">
                      <div className="relative h-[560px] w-full">
                        <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-full bg-dark md:shadow-2xl">
