              ...
              <div className="grid grid-cols-2">
                <div className="col-span-2 mb-7 md:col-span-1 md:mb-0">
                  <div className="relative mx-auto mt-0 max-w-2xl text-left md:mt-12">
                    ...
                    <h2 className="mb-3">
                      <TypeIt
                        ...
                        getBeforeInit={(instance) => {
                          instance
                            .type("Data infrastructure and analysis")
                            .pause(750)
                            .delete(32)
                            .pause(500)
                            .type("IT Cloud")
                    ...
                    <p className="mb-9 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-xl md:text-3xl">
                ...
                <div className="col-span-2 md:col-span-1">
                  <div className="mx-auto max-w-2xl">
                    <div className="relative mx-auto w-full">
                      <div className="relative h-[560px] w-full rounded-full">
                        {/* <Image
