...
const EspaceEntreprise = () => {
  ...
  return (
    <main
      className="min-h-screen w-full bg-auto bg-center bg-no-repeat"
      style={{
      ...
      <div className="relative flex min-h-screen items-center justify-center px-4">
        ...
        <div className="absolute w-full max-w-2xl rounded-full border-x-[20px] border-y-[1px] border-slate-200 bg-black/30 p-8 backdrop-blur-xl">
          ...
          >
            ...
            >
              digital <span className="text-[#f5c034]">workspace</span><br />(Corporate space)
            </motion.h1>
          </motion.div>
          <motion.div
            initial={{ x: 300, opacity: 0 }}
          ...
          >
            ...
            >
              The Enterprise space is the workspace designed by Datalys to facilitate the follow-up of its customers' projects.
            </motion.p>
          </motion.div>
          ...
          >
            Automatic redirection <br /> in a few seconds...
          </motion.p>
        </div>
      </div>
    </main>
